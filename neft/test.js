...
it('Main page content', function(done) {
    request('http://localhost:5004' , function(error, response, body) {
...
it('API signin', function(done) {
    request('http://localhost:5004/neft/signin' , function(error, response, body) {
...
it('API - try to access api without jwt token get 401 error', function(done) {
    request('http://localhost:5004/neft/admin/history' , function(error, response, body) {
        //console.log(error+response.body)
