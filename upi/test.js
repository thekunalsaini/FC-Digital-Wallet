...
it('Main page content', function(done) {
    request('http://localhost:5003' , function(error, response, body) {
...
it('API signin', function(done) {
    request('http://localhost:5003/upi/signin' , function(error, response, body) {
...
it('API - try to access api without jwt token get 401 error', function(done) {
    request('http://localhost:5003/upi/admin/history' , function(error, response, body) {
        //console.log(error+response.body)
